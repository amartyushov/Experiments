...
public class GridLastic {
	...
	public void beforeMethod() throws Exception {
		...
		driver = new RemoteWebDriver(new URL("http://nCtAKSO0p1KUz6J6TBcd5pqnPqUYLoHY:Q1prJ4iYVTJlPiizKkDFAUTgaD5MRCBy@MART.gridlastic.com:80/wd/hub"), capabilities);
