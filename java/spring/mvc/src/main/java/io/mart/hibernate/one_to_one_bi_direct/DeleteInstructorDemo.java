...
public class DeleteInstructorDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int theId = 3; // check what is present in db now
            ...
            instructorDetail.getInstructor().setInstructorDetail(null); // to be able to delete instructorDetail without cascade
